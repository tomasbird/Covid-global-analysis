...
# Running test models with Costa Rica data
gam1 <- gam(data=filter(google_no_sub, country_alpha3 == "CRI"), residential ~ C1 + weekend + s(julian)) 
gam2 <- gam(data=filter(google_no_sub, country_alpha3 == "CRI"), residential ~ C2 + weekend + s(julian))
gam3 <- gam(data=filter(google_no_sub, country_alpha3 == "CRI"), residential ~ C3 + weekend + s(julian))
gam4 <- gam(data=filter(google_no_sub, country_alpha3 == "CRI"), residential ~ C4 + weekend + s(julian))
gam5 <- gam(data=filter(google_no_sub, country_alpha3 == "CRI"), residential ~ C5 + weekend + s(julian))
gam6 <- gam(data=filter(google_no_sub, country_alpha3 == "CRI"), residential ~ C6 + weekend + s(julian))
gam7 <- gam(data=filter(google_no_sub, country_alpha3 == "CRI"), residential ~ C7 + weekend + s(julian))
gam8 <- gam(data=filter(google_no_sub, country_alpha3 == "CRI"), residential ~ C8 + weekend + s(julian))
...
# PLOT 
ggplot(filter(google, country_alpha3 =="CRI" ), aes(x=julian, y=residential)) + 
      geom_line() + 
      geom_vline(xintercept = 77, colour = "red")
